use darksol::{
    CommitmentCipherText, DepositRequest, PreCommitments, SP1Groth16Proof, ShieldCipherText,
    TransferRequest, WithdrawRequest,
};
use solana_sdk::pubkey::Pubkey;
use types::{PublicData, generate_nullifier, utxo::UTXO};
...
pub fn create_transfer_instructions_data_test(
    token_id: &Pubkey,
    receiver_public_viewing_key: Vec<u8>,
    inputs: Vec<TransferInput>,
    outputs: Vec<TransferOutput>,
    ...
    let proof = borsh::to_vec(&SP1Groth16Proof {
        proof: vec![],
        sp1_public_inputs: borsh::to_vec(&PublicData {
    ...
    Ok((instructions_data, commiments))
}
...
pub fn create_withdraw_instructions_data_test(
    token_id: &Pubkey,
    amount: u64,
    inputs: Vec<TransferInput>,
    merkle_root: Vec<u8>,
